...
var rootCmd = &cobra.Command{
	Use:   "kubeam",
	Short: "Kubernetes Application and Workflow manager",
	Long: `Kubernetes Application and Workflow manager
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".kubeam" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".kubeam")
	}
